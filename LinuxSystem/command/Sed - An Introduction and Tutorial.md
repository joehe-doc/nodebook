...
*   [Arguments and invocation of sed](http://www.grymoire.com/Unix/Sed.html#uh-12)
...
*   [GNU sed Command Line arguments](http://www.grymoire.com/Unix/Sed.html#uh-62b)
    *   [The -posix argument](http://www.grymoire.com/Unix/Sed.html#uh-62c)
...
## [/g - Global replacement](http://www.grymoire.com/Unix/Sed.html#toc-uh-6)
...
## [/I - Ignore Case](http://www.grymoire.com/Unix/Sed.html#toc-uh-10a)
...
## [Example of Context Grep](http://www.grymoire.com/Unix/Sed.html#toc-uh-54)
...
## [Debugging with l](http://www.grymoire.com/Unix/Sed.html#toc-uh-59a)
...
## [Passing regular expressions as arguments](http://www.grymoire.com/Unix/Sed.html#toc-uh-62)
...
## [The -s Separate argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62g)
...
## [The -i in-place argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62h)
...
## [The --follow-symlinks argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62i)
...
## [The -b Binary argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62j)
...
## [The -r Extended Regular Expression argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62k)

When I mention patterns, such as "s/pattern/", the pattern is a regular expression. There are two common classes of regular expressions, the original "basic" expressions, and the "extended" regular expressions. For more on the differences see [My tutorial on regular expressions](http://www.grymoire.com/Unix/../Unix/Regular.html) and the [the section on extended regular expressions](http://www.grymoire.com/Unix/../Unix/Regular.html#uh-12). Because the meaning of certain characters are different between the regular and extended expressions, you need a command line argument to enable _sed_ to use the extension. To enable this extension, use the "-r" command, as mentioned in [the example on finding duplicated words on a line](http://www.grymoire.com/Unix/Sed.html#uh-4)
...
I already mentioned that Mac OS X and FreeBSD uses [-E](http://www.grymoire.com/Unix/Sed.html#uh-62h2) instead of [-r](http://www.grymoire.com/Unix/Sed.html#uh-62k).

## [The -u Unbuffered argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62l)
...
## [FreeBSD Extensions](http://www.grymoire.com/Unix/Sed.html#toc-uh-62n)
...
## [The -a or delayed open Argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62n1)

Normally, as soon as sed starts up, it opens all files that are refered to by the ["w"](http://www.grymoire.com/Unix/Sed.html#uh-36) command. The FreeBSD version of sed has an option to delay this action until the "w" command is executed.

## [The -I in-place argument](http://www.grymoire.com/Unix/Sed.html#toc-uh-62n2)

FreeBSD added a "-I" option that is similar to the [-i](http://www.grymoire.com/Unix/Sed.html#uh-62h) option. The "-i" option treats the editing each file as a separate instance of _sed_. If the "-I" option is used, then line numbers do not get reset at the beginning of each line, and ranges of addresses continue from one file to the next. That is, if you used the range '/BEGIN/,/END/' and you used the "-I" option, you can have the "BEGIN" in the first file, and "END" in the second file, and the commands executed within the range would span both files. If you used "-i", then the commands would not.

And like the [-i](http://www.grymoire.com/Unix/Sed.html#uh-62h) option, the extension used to store the backup file must be specified.

## [-E or Extended Regular Expressions](http://www.grymoire.com/Unix/Sed.html#toc-uh-62n3)

I mentioned extended regular expressions [earlier](http://www.grymoire.com/Unix/Sed.html#uh-4a). FreeBSD (and Mac OS X) uses "-E" to enable this. However, FreeBSD later added the [-r](http://www.grymoire.com/Unix/Sed.html#uh-62k) command to be compatible with GNU sed.

## [Using word boundries](http://www.grymoire.com/Unix/Sed.html#toc-uh-62o)
...
## [Command Summary](http://www.grymoire.com/Unix/Sed.html#toc-uh-63)
...
## [In Conclusion](http://www.grymoire.com/Unix/Sed.html#toc-uh-64)
...
## [More References](http://www.grymoire.com/Unix/Sed.html#toc-uh-65)

This concludes my tutorial on sed. Other of my UNIX shell tutorials can be found [here.](http://www.grymoire.com/Unix/index.html) Other shell tutorials and references can be found at
...
_This document was translated by troff2html v0.21 on September 22, 2001 and then manually edited to make it compliant with:_ [![Valid HTML 4.01!](../../_resources/7cdda7179dbe4087b20a22efe8612e10.png)](http://validator.w3.org/check?uri=referer)